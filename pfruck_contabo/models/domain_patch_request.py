...
class DomainPatchRequest(BaseModel):
    ...
    DomainPatchRequest
    """ # noqa: E501
    nameservers: Optional[List[Nameserver]] = Field(default=None, description="Nameservers")
    handles: Optional[DomainHandles] = Field(default=None, description="The handles of the domain")
    __properties: ClassVar[List[str]] = ["nameservers", "handles"]

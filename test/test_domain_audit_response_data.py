...
class TestDomainAuditResponseData(unittest.TestCase):
    """DomainAuditResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainAuditResponseData:
        """Test DomainAuditResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainAuditResponseData`
        """
        model = DomainAuditResponseData()
        if include_optional:
            return DomainAuditResponseData(
                id = 12345,
                action = 'CREATED',
    ...
    def testDomainAuditResponseData(self):
        """Test DomainAuditResponseData"""

...
class UpgradeInstanceData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant_id, customer_id, instance_id, created_date, addons_ids, *args, **kwargs):  # noqa: E501
        """UpgradeInstanceData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, customer_id, instance_id, created_date, addons_ids, *args, **kwargs):  # noqa: E501
        """UpgradeInstanceData - a model defined in OpenAPI

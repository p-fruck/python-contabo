...
class ZoneAuditResponseData(BaseModel):
    """
    ...
    name: StrictStr = Field(description="DNS Zone name")
    changes: Optional[Dict[str, Any]] = Field(default=None, description="List of actual changes.")
    __properties: ClassVar[List[str]] = ["id", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "name", "changes"]

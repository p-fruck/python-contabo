...
class TestPatchPrivateNetworkResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchPrivateNetworkResponse:
        """Test PatchPrivateNetworkResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchPrivateNetworkResponse`
        """
        model = PatchPrivateNetworkResponse()
        if include_optional:

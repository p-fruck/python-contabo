...
class ReinstallInstanceResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[ReinstallInstanceResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """ReinstallInstanceResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this ReinstallInstanceResponse.  # noqa: E501


        :return: The data of this ReinstallInstanceResponse.  # noqa: E501
        :rtype: list[ReinstallInstanceResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ReinstallInstanceResponse.


        :param data: The data of this ReinstallInstanceResponse.  # noqa: E501
        :type: list[ReinstallInstanceResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ReinstallInstanceResponse.  # noqa: E501


        :return: The links of this ReinstallInstanceResponse.  # noqa: E501
        :rtype: AllOfReinstallInstanceResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this ReinstallInstanceResponse.


        :param links: The links of this ReinstallInstanceResponse.  # noqa: E501
        :type: AllOfReinstallInstanceResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReinstallInstanceResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReinstallInstanceResponse):
            return False

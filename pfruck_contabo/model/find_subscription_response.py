...
class FindSubscriptionResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'links': (FindSubscriptionResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindSubscriptionResponse - a model defined in OpenAPI

        Args:
            data ([ExtendedSubscriptionResponse]):
            links (FindSubscriptionResponseLinks):

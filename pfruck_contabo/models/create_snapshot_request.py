...
class CreateSnapshotRequest(object):
    ...
    @property
    def name(self):
        """Gets the name of this CreateSnapshotRequest.  # noqa: E501

        The name of the snapshot. It may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per snapshot.  # noqa: E501

        :return: The name of this CreateSnapshotRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this CreateSnapshotRequest.  # noqa: E501
        :type: str
        """
        if name is None:

...
class InstanceDetails(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instance_id, display_name, name, product_id, ip_config, status, region, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, instance_id, display_name, name, product_id, ip_config, status, region, *args, **kwargs):  # noqa: E501
        """InstanceDetails - a model defined in OpenAPI

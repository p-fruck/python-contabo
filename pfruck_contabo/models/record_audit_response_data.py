...
class RecordAuditResponseData(BaseModel):
    """
    ...
    record_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The identifier of the Zone recordd", alias="recordId")
    zone_name: StrictStr = Field(description="DNS Zone name", alias="zoneName")
    changes: Optional[Dict[str, Any]] = Field(default=None, description="List of actual changes.")
    __properties: ClassVar[List[str]] = ["id", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "recordId", "zoneName", "changes"]

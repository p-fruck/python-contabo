...
class ApplicationResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'requirements': (ApplicationResponseRequirements,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, application_id, tenant_id, customer_id, name, description, type, application_config, requirements, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            application_config ([ApplicationConfig]): Application Config
            requirements (ApplicationResponseRequirements):
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_id, tenant_id, customer_id, name, description, type, application_config, requirements, *args, **kwargs):  # noqa: E501
        """ApplicationResponse - a model defined in OpenAPI

...
class ListPaymentMethodResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([PaymentMethodResponse],),  # noqa: E501
            'links': (ListPaymentMethodResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """ListPaymentMethodResponse - a model defined in OpenAPI

        Args:
            data ([PaymentMethodResponse]):
            links (ListPaymentMethodResponseLinks):

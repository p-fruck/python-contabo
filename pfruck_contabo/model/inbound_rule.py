...
class InboundRule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, protocol, src_ports, src_cidr, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            action (str): Actions to be applied to the incoming connections.. defaults to "accept", must be one of ["accept", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, protocol, src_ports, src_cidr, status, *args, **kwargs):  # noqa: E501
        """InboundRule - a model defined in OpenAPI

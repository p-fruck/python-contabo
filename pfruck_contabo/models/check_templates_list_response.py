...
class CheckTemplatesListResponse(BaseModel):
    """
    ...
    data: List[CheckTemplateResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CheckTemplateResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

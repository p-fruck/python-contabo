...
class CustomImagesStatsResponse(object):
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """CustomImagesStatsResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this CustomImagesStatsResponse.  # noqa: E501


        :return: The data of this CustomImagesStatsResponse.  # noqa: E501
        :rtype: list[CustomImagesStatsResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CustomImagesStatsResponse.


        :param data: The data of this CustomImagesStatsResponse.  # noqa: E501
        :type: list[CustomImagesStatsResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this CustomImagesStatsResponse.  # noqa: E501


        :return: The links of this CustomImagesStatsResponse.  # noqa: E501
        :rtype: AllOfCustomImagesStatsResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this CustomImagesStatsResponse.


        :param links: The links of this CustomImagesStatsResponse.  # noqa: E501
        :type: AllOfCustomImagesStatsResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomImagesStatsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomImagesStatsResponse):
            return False

...
class InstanceResetPasswordActionResponseData(BaseModel):
    """
    ...
    instance_id: StrictInt = Field(description="Compute instance / resource id", alias="instanceId")
    action: StrictStr = Field(description="Action that was triggered")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "instanceId", "action"]

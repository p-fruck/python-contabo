...
class UnassignInstanceFirewallResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (AssignInstanceFirewallResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """UnassignInstanceFirewallResponse - a model defined in OpenAPI

        Args:
            links (AssignInstanceFirewallResponseLinks):

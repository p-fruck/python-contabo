...
class ImagesApi:
    ...
    def retrieve_image_list(
        ...
        gpu: Annotated[Optional[StrictBool], Field(description="Flag indicating that image can be used with for a GPU product.")] = None,
        ...
        :param gpu: Flag indicating that image can be used with for a GPU product.
        :type gpu: bool

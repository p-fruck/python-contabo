...
class ApiPermissionsResponse(object):
    ...
    def __init__(self, api_name=None, actions=None):  # noqa: E501
        """ApiPermissionsResponse - a model defined in Swagger"""  # noqa: E501
        self._api_name = None
        self._actions = None
    ...
    @property
    def api_name(self):
        """Gets the api_name of this ApiPermissionsResponse.  # noqa: E501

        API endpoint. In order to get a list availbale api enpoints please refer to the GET api-permissions endpoint.  # noqa: E501

        :return: The api_name of this ApiPermissionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def api_name(self, api_name):
        """Sets the api_name of this ApiPermissionsResponse.

        API endpoint. In order to get a list availbale api enpoints please refer to the GET api-permissions endpoint.  # noqa: E501

        :param api_name: The api_name of this ApiPermissionsResponse.  # noqa: E501
        :type: str
        """
        if api_name is None:
    ...
    @property
    def actions(self):
        """Gets the actions of this ApiPermissionsResponse.  # noqa: E501
        ...
        :return: The actions of this ApiPermissionsResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def actions(self, actions):
        """Sets the actions of this ApiPermissionsResponse.

        Action allowed for the API endpoint. Basically `CREATE` corresponds to POST endpoints, `READ` to GET endpoints, `UPDATE` to PATCH / PUT endpoints and `DELETE` to DELETE endpoints.  # noqa: E501

        :param actions: The actions of this ApiPermissionsResponse.  # noqa: E501
        :type: list[str]
        """
        if actions is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiPermissionsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiPermissionsResponse):
            return False

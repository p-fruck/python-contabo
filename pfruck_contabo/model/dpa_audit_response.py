...
class DpaAuditResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, dpa_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """DpaAuditResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, dpa_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """DpaAuditResponse - a model defined in OpenAPI

...
class DomainCancel(BaseModel):
    ...
    sld: StrictStr = Field(description="Domain SLD")
    tld: StrictStr = Field(description="Domain TLD")
    cancel_date: datetime = Field(description="The cancel date of domain", alias="cancelDate")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "domain", "sld", "tld", "cancelDate"]

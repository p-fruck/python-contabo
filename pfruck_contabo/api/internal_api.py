...
class InternalApi(object):
    ...
    def create_ticket(self, body, x_request_id, **kwargs):  # noqa: E501
        """Create a new support ticket  # noqa: E501

        Create a new support ticket.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ticket(body, x_request_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateTicketRequest body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_ticket_with_http_info(body, x_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_ticket_with_http_info(body, x_request_id, **kwargs)  # noqa: E501
            return data

    def create_ticket_with_http_info(self, body, x_request_id, **kwargs):  # noqa: E501
        """Create a new support ticket  # noqa: E501

        Create a new support ticket.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ticket_with_http_info(body, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_request_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_request_id` when calling `create_ticket`")  # noqa: E501

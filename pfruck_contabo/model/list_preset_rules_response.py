...
class ListPresetRulesResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([PresetRulesResponse],),  # noqa: E501
            'links': (ListPresetRulesResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """ListPresetRulesResponse - a model defined in OpenAPI

        Args:
            data ([PresetRulesResponse]):
            links (ListPresetRulesResponseLinks):

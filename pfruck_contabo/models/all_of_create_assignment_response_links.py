...
import six
from pfruck_contabo.models.tag_assignment_self_links import TagAssignmentSelfLinks  # noqa: F401,E501

class AllOfCreateAssignmentResponseLinks(TagAssignmentSelfLinks):
    ...
    if hasattr(TagAssignmentSelfLinks, "swagger_types"):
        swagger_types.update(TagAssignmentSelfLinks.swagger_types)

    attribute_map = {
    }
    if hasattr(TagAssignmentSelfLinks, "attribute_map"):
        attribute_map.update(TagAssignmentSelfLinks.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfCreateAssignmentResponseLinks - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        TagAssignmentSelfLinks.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfCreateAssignmentResponseLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfCreateAssignmentResponseLinks):
            return False

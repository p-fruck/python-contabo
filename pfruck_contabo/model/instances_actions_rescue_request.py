...
class InstancesActionsRescueRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InstancesActionsRescueRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            root_password (int): `secretId` of the password to login into rescue system for the `root` user.. [optional]  # noqa: E501
            ssh_keys ([int]): Array of `secretId`s of public SSH keys for logging into rescue system as `root` user.. [optional]  # noqa: E501

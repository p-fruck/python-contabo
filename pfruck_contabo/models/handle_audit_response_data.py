...
class HandleAuditResponseData(BaseModel):
    """
    ...
    handle_id: StrictStr = Field(description="The identifier of the handle", alias="handleId")
    changes: Optional[Dict[str, Any]] = Field(default=None, description="List of actual changes.")
    __properties: ClassVar[List[str]] = ["id", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "handleId", "changes"]

...
class UserSwitchAccountDefaultResponse(BaseModel):
    """
    UserSwitchAccountDefaultResponse
    """ # noqa: E501
    data: List[UserSwitchAccount]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [UserSwitchAccount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

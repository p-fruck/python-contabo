...
class UpdateSecretResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (UpdateSecretResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """UpdateSecretResponse - a model defined in OpenAPI

        Args:
            links (UpdateSecretResponseLinks):

...
class UnassignVipResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([VipResponse],),  # noqa: E501
            'links': (AssignVipResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """UnassignVipResponse - a model defined in OpenAPI

        Args:
            data ([VipResponse]):
            links (AssignVipResponseLinks):

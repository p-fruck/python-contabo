...
class ClientResponse(BaseModel):
    ...
    id: StrictStr = Field(description="Client's id")
    client_id: StrictStr = Field(description="IDM client id", alias="clientId")
    secret: StrictStr = Field(description="IDM client secret")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "id", "clientId", "secret"]

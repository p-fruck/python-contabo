...
class TagAssignmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_assignment_endpoint = _Endpoint(
            settings={
                'response_type': (CreateAssignmentResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/tags/{tagId}/assignments/{resourceType}/{resourceId}',
        ...
        self.delete_assignment_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearer'
        ...
        self.retrieve_assignment_endpoint = _Endpoint(
            settings={
                'response_type': (FindAssignmentResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/tags/{tagId}/assignments/{resourceType}/{resourceId}',
                'operation_id': 'retrieve_assignment',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.retrieve_assignment_list_endpoint = _Endpoint(
            settings={
                'response_type': (ListAssignmentResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/tags/{tagId}/assignments',
                'operation_id': 'retrieve_assignment_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_assignment(
        ...
        **kwargs
        ...
        kwargs['resource_id'] = \
            resource_id
        return self.create_assignment_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_assignment(
        ...
        **kwargs
        ...
        kwargs['resource_id'] = \
            resource_id
        return self.delete_assignment_endpoint.call_with_http_info(**kwargs)
    ...
    def retrieve_assignment(
        ...
        **kwargs
        ...
        kwargs['resource_id'] = \
            resource_id
        return self.retrieve_assignment_endpoint.call_with_http_info(**kwargs)
    ...
    def retrieve_assignment_list(
        ...
        **kwargs
        ...
        kwargs['tag_id'] = \
            tag_id
        return self.retrieve_assignment_list_endpoint.call_with_http_info(**kwargs)

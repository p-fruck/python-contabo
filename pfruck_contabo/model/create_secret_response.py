...
class CreateSecretResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'links': (CreateSecretResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """CreateSecretResponse - a model defined in OpenAPI

        Args:
            data ([SecretResponse]):
            links (CreateSecretResponseLinks):

...
class CreateCustomImageFailResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, status_code, *args, **kwargs):  # noqa: E501
        """CreateCustomImageFailResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, status_code, *args, **kwargs):  # noqa: E501
        """CreateCustomImageFailResponse - a model defined in OpenAPI

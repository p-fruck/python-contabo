...
class CreateCustomImageRequest(BaseModel):
    """
    ...
    os_type: StrictStr = Field(description="Provided type of operating system (OS). Please specify `Windows` for MS Windows and `Linux` for other OS. Specifying wrong OS type may lead to disfunctional cloud instance.", alias="osType")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "url", "osType", "version"]

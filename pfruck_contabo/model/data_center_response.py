...
class DataCenterResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, slug, capabilities, s3_url, region_name, region_slug, tenant_id, customer_id, *args, **kwargs):  # noqa: E501
        """DataCenterResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, slug, capabilities, s3_url, region_name, region_slug, tenant_id, customer_id, *args, **kwargs):  # noqa: E501
        """DataCenterResponse - a model defined in OpenAPI

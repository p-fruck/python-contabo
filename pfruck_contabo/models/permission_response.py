...
class PermissionResponse(object):
    ...
    swagger_types = {
        'api_name': 'str',
        'actions': 'list[str]',
        'resources': 'list[ResourcePermissionsResponse]'
    }
    ...
    @property
    def api_name(self):
        """Gets the api_name of this PermissionResponse.  # noqa: E501

        API endpoint. In order to get a list availbale api enpoints please refer to the GET api-permissions endpoint.  # noqa: E501

        :return: The api_name of this PermissionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def api_name(self, api_name):
        """Sets the api_name of this PermissionResponse.

        API endpoint. In order to get a list availbale api enpoints please refer to the GET api-permissions endpoint.  # noqa: E501

        :param api_name: The api_name of this PermissionResponse.  # noqa: E501
        :type: str
        """
        if api_name is None:
    ...
    @property
    def actions(self):
        """Gets the actions of this PermissionResponse.  # noqa: E501
        ...
        :return: The actions of this PermissionResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def actions(self, actions):
        """Sets the actions of this PermissionResponse.

        Action allowed for the API endpoint. Basically `CREATE` corresponds to POST endpoints, `READ` to GET endpoints, `UPDATE` to PATCH / PUT endpoints and `DELETE` to DELETE endpoints.  # noqa: E501

        :param actions: The actions of this PermissionResponse.  # noqa: E501
        :type: list[str]
        """
        if actions is None:
    ...
    @property
    def resources(self):
        """Gets the resources of this PermissionResponse.  # noqa: E501


        :return: The resources of this PermissionResponse.  # noqa: E501
    ...
    def resources(self, resources):
        """Sets the resources of this PermissionResponse.


        :param resources: The resources of this PermissionResponse.  # noqa: E501

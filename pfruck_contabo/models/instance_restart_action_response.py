...
class InstanceRestartActionResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[InstanceRestartActionResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """InstanceRestartActionResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this InstanceRestartActionResponse.  # noqa: E501


        :return: The data of this InstanceRestartActionResponse.  # noqa: E501
        :rtype: list[InstanceRestartActionResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InstanceRestartActionResponse.


        :param data: The data of this InstanceRestartActionResponse.  # noqa: E501
        :type: list[InstanceRestartActionResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this InstanceRestartActionResponse.  # noqa: E501


        :return: The links of this InstanceRestartActionResponse.  # noqa: E501
        :rtype: AllOfInstanceRestartActionResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this InstanceRestartActionResponse.


        :param links: The links of this InstanceRestartActionResponse.  # noqa: E501
        :type: AllOfInstanceRestartActionResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InstanceRestartActionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstanceRestartActionResponse):
            return False

...
class FirewallAuditResponse(BaseModel):
    ...
    firewall_id: StrictStr = Field(description="The identifier of the Firewall", alias="firewallId")
    ...
    __properties: ClassVar[List[str]] = ["id", "firewallId", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "changes"]

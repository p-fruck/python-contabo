...
class SecretsAuditsApi(object):
    ...
    def retrieve_secret_audits_list(self, x_request_id, **kwargs):  # noqa: E501
        """List history about your secrets (audit)  # noqa: E501

        List and filters the history about your secrets.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_secret_audits_list(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        :param int secret_id: The id of the secret.
        ...
        if kwargs.get('async_req'):
            return self.retrieve_secret_audits_list_with_http_info(x_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_secret_audits_list_with_http_info(x_request_id, **kwargs)  # noqa: E501
            return data

    def retrieve_secret_audits_list_with_http_info(self, x_request_id, **kwargs):  # noqa: E501
        """List history about your secrets (audit)  # noqa: E501

        List and filters the history about your secrets.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_secret_audits_list_with_http_info(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['x_request_id', 'x_trace_id', 'page', 'size', 'order_by', 'secret_id', 'request_id', 'changed_by']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method retrieve_secret_audits_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('x_request_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_request_id` when calling `retrieve_secret_audits_list`")  # noqa: E501
        ...
        if 'secret_id' in params:
            query_params.append(('secretId', params['secret_id']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ListSecretAuditResponse',  # noqa: E501

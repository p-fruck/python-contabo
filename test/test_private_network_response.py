...
class TestPrivateNetworkResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrivateNetworkResponse:
        """Test PrivateNetworkResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateNetworkResponse`
        """
        model = PrivateNetworkResponse()
        if include_optional:

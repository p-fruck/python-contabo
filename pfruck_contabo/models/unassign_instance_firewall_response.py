...
class UnassignInstanceFirewallResponse(BaseModel):
    """
    UnassignInstanceFirewallResponse
    """ # noqa: E501
    links: InstanceAssignmentSelfLinks1 = Field(description="Links for easy navigation.", alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": InstanceAssignmentSelfLinks1.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj

...
class InstanceStartActionResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[InstanceStartActionResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """InstanceStartActionResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this InstanceStartActionResponse.  # noqa: E501


        :return: The data of this InstanceStartActionResponse.  # noqa: E501
        :rtype: list[InstanceStartActionResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InstanceStartActionResponse.


        :param data: The data of this InstanceStartActionResponse.  # noqa: E501
        :type: list[InstanceStartActionResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this InstanceStartActionResponse.  # noqa: E501


        :return: The links of this InstanceStartActionResponse.  # noqa: E501
        :rtype: AllOfInstanceStartActionResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this InstanceStartActionResponse.


        :param links: The links of this InstanceStartActionResponse.  # noqa: E501
        :type: AllOfInstanceStartActionResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InstanceStartActionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstanceStartActionResponse):
            return False

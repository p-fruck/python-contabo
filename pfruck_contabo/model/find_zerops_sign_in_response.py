...
class FindZeropsSignInResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ZeropsSignInResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """FindZeropsSignInResponse - a model defined in OpenAPI

        Args:
            data ([ZeropsSignInResponse]):

...
class BulkDeleteDnsZoneRecordsRequest(BaseModel):
    """
    BulkDeleteDnsZoneRecordsRequest
    """ # noqa: E501
    record_ids: List[StrictInt] = Field(description="List of zone record ids to delete", alias="recordIds")
    __properties: ClassVar[List[str]] = ["recordIds"]

...
class UpgradeInstanceProductData(BaseModel):
    """
    ...
    instance_id: StrictInt = Field(description="The identifier of the instance", alias="instanceId")
    ticket_number: StrictStr = Field(description="Support ticket number created for the upgrade", alias="ticketNumber")
    automatic: StrictBool = Field(description="Indicates whether the upgrade will be processed automatically or manually.")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "instanceId", "ticketNumber", "automatic"]

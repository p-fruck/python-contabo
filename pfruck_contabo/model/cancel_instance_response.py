...
class CancelInstanceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CancelInstanceResponseData],),  # noqa: E501
            'links': (PatchInstanceResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """CancelInstanceResponse - a model defined in OpenAPI

        Args:
            data ([CancelInstanceResponseData]):
            links (PatchInstanceResponseLinks):

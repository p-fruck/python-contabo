...
class DomainAuditResponseData(BaseModel):
    """
    ...
    domain: StrictStr = Field(description="The identifier of the domain")
    changes: Optional[Dict[str, Any]] = Field(default=None, description="List of actual changes.")
    __properties: ClassVar[List[str]] = ["id", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "domain", "changes"]

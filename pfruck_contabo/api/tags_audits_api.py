...
class TagsAuditsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_tag_audits_list_endpoint = _Endpoint(
            settings={
                'response_type': (ListTagAuditsResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/tags/audits',
                'operation_id': 'retrieve_tag_audits_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_tag_audits_list(
        ...
        **kwargs
        ...
        kwargs['x_request_id'] = \
            x_request_id
        return self.retrieve_tag_audits_list_endpoint.call_with_http_info(**kwargs)

...
class InstanceStopActionResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[InstanceStopActionResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """InstanceStopActionResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this InstanceStopActionResponse.  # noqa: E501


        :return: The data of this InstanceStopActionResponse.  # noqa: E501
        :rtype: list[InstanceStopActionResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InstanceStopActionResponse.


        :param data: The data of this InstanceStopActionResponse.  # noqa: E501
        :type: list[InstanceStopActionResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this InstanceStopActionResponse.  # noqa: E501


        :return: The links of this InstanceStopActionResponse.  # noqa: E501
        :rtype: AllOfInstanceStopActionResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this InstanceStopActionResponse.


        :param links: The links of this InstanceStopActionResponse.  # noqa: E501
        :type: AllOfInstanceStopActionResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InstanceStopActionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstanceStopActionResponse):
            return False

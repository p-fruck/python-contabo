...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_tag_list_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/tags',
                'operation_id': 'retrieve_tag_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_tag_endpoint = _Endpoint(
            settings={
                'response_type': (UpdateTagResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/tags/{tagId}',
    ...
    def create_tag(
        ...
        **kwargs
        ...
        >>> thread = api.create_tag(x_request_id, create_tag_request, async_req=True)
        >>> result = thread.get()
    ...
    def retrieve_tag_list(
        ...
        **kwargs
        ...
        kwargs['x_request_id'] = \
            x_request_id
        return self.retrieve_tag_list_endpoint.call_with_http_info(**kwargs)
    ...
    def update_tag(
        ...
        **kwargs
        ...
        >>> thread = api.update_tag(x_request_id, tag_id, update_tag_request, async_req=True)
        >>> result = thread.get()

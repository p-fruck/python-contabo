# pfruck_contabo.InstanceActionsAuditsApi
...
> ListInstancesActionsAuditResponse retrieve_instances_actions_audits_list(x_request_id)
...
from pfruck_contabo.api import instance_actions_audits_api
...
with pfruck_contabo.ApiClient(configuration) as api_client:
    ...
    api_instance = instance_actions_audits_api.InstanceActionsAuditsApi(api_client)
    ...
    try:
        # List history about your actions (audit) triggered via the API
        api_response = api_instance.retrieve_instances_actions_audits_list(x_request_id)
        pprint(api_response)

...
class AssignmentAuditResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant_id, customer_id, id, resource_id, resource_type, tag_id, action, timestamp, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """AssignmentAuditResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            changes ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Changes made for a specific Tag. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, customer_id, id, resource_id, resource_type, tag_id, action, timestamp, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """AssignmentAuditResponse - a model defined in OpenAPI

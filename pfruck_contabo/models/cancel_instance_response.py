...
class CancelInstanceResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[CancelInstanceResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """CancelInstanceResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this CancelInstanceResponse.  # noqa: E501


        :return: The data of this CancelInstanceResponse.  # noqa: E501
        :rtype: list[CancelInstanceResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CancelInstanceResponse.


        :param data: The data of this CancelInstanceResponse.  # noqa: E501
        :type: list[CancelInstanceResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this CancelInstanceResponse.  # noqa: E501


        :return: The links of this CancelInstanceResponse.  # noqa: E501
        :rtype: AllOfCancelInstanceResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this CancelInstanceResponse.


        :param links: The links of this CancelInstanceResponse.  # noqa: E501
        :type: AllOfCancelInstanceResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CancelInstanceResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelInstanceResponse):
            return False

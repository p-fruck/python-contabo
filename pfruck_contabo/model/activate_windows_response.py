...
class ActivateWindowsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (ActivateWindowsResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """ActivateWindowsResponse - a model defined in OpenAPI

        Args:
            links (ActivateWindowsResponseLinks):

...
class PatchObjectStorageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, *args, **kwargs):  # noqa: E501
        """PatchObjectStorageRequest - a model defined in OpenAPI

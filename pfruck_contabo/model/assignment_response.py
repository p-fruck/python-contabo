...
class AssignmentResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant_id, customer_id, tag_id, tag_name, resource_type, resource_id, resource_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, customer_id, tag_id, tag_name, resource_type, resource_id, resource_name, *args, **kwargs):  # noqa: E501
        """AssignmentResponse - a model defined in OpenAPI

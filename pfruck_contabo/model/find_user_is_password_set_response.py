...
class FindUserIsPasswordSetResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([UserIsPasswordSetResponse],),  # noqa: E501
            'links': (FindUserIsPasswordSetResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindUserIsPasswordSetResponse - a model defined in OpenAPI

        Args:
            data ([UserIsPasswordSetResponse]):
            links (FindUserIsPasswordSetResponseLinks):

...
class CustomerAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, address, country, city, street, zip_code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, address, country, city, street, zip_code, *args, **kwargs):  # noqa: E501
        """CustomerAddress - a model defined in OpenAPI

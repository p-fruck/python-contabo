...
class ImageResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_id, tenant_id, customer_id, name, description, url, size_mb, uploaded_size_mb, os_type, version, format, status, error_message, standard_image, creation_date, last_modified_date, *args, **kwargs):  # noqa: E501
        """ImageResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, image_id, tenant_id, customer_id, name, description, url, size_mb, uploaded_size_mb, os_type, version, format, status, error_message, standard_image, creation_date, last_modified_date, *args, **kwargs):  # noqa: E501
        """ImageResponse - a model defined in OpenAPI

...
class VipAuditResponse(BaseModel):
    """
    VipAuditResponse
    """ # noqa: E501
    id: StrictInt = Field(description="The identifier of the audit entry.")
    vip_id: StrictStr = Field(description="The identifier of the VIP", alias="vipId")
    ...
    __properties: ClassVar[List[str]] = ["id", "vipId", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "changes"]

...
class FindClientResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ClientResponse],),  # noqa: E501
            'links': (FindClientResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindClientResponse - a model defined in OpenAPI

        Args:
            data ([ClientResponse]):
            links (FindClientResponseLinks):

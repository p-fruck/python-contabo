...
class UpgradeObjectStorageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([UpgradeObjectStorageResponseData],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, data, *args, **kwargs):  # noqa: E501
        """UpgradeObjectStorageResponse - a model defined in OpenAPI

        Args:
            links (UpgradeObjectStorageResponseLinks):
            data ([UpgradeObjectStorageResponseData]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, data, *args, **kwargs):  # noqa: E501
        """UpgradeObjectStorageResponse - a model defined in OpenAPI

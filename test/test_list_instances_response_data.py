...
class TestListInstancesResponseData(unittest.TestCase):
    """ListInstancesResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInstancesResponseData:
        """Test ListInstancesResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInstancesResponseData`
        """
        model = ListInstancesResponseData()
        if include_optional:
            return ListInstancesResponseData(
                tenant_id = 'DE',
    ...
    def testListInstancesResponseData(self):
        """Test ListInstancesResponseData"""

...
class PrivateNetworkAuditResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'private_network_id': (float,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, private_network_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """PrivateNetworkAuditResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            changes ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): List of actual changes.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, private_network_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """PrivateNetworkAuditResponse - a model defined in OpenAPI

...
class SubscriptionProduct(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_name, product_id, product_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_name, product_id, product_type, *args, **kwargs):  # noqa: E501
        """SubscriptionProduct - a model defined in OpenAPI

...
class CreateObjectStorageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CreateObjectStorageResponseData],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """CreateObjectStorageResponse - a model defined in OpenAPI

        Args:
            data ([CreateObjectStorageResponseData]):

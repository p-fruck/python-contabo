...
class DomainPendingActionsListResponse(BaseModel):
    """
    DomainPendingActionsListResponse
    """ # noqa: E501
    data: List[DomainPendingActionResponse] = Field(description="Domains with an unacknowledged outbound transfer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DomainPendingActionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

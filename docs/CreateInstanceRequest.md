...
**product_id** | **str** | Default is V153 | [optional] [default to 'V153']
...
**period** | **int** | Initial contract period in months. Available periods are: 1, 12 and 24 months. Default to 1 month | [default to 1]
**display_name** | **str** | The display name of the instance. Pass an empty string to leave it unset. | [optional] 

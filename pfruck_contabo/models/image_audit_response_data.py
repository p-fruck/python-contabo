...
class ImageAuditResponseData(BaseModel):
    """
    ...
    image_id: StrictStr = Field(description="The identifier of the image", alias="imageId")
    changes: Optional[Dict[str, Any]] = Field(default=None, description="List of actual changes.")
    __properties: ClassVar[List[str]] = ["id", "action", "timestamp", "tenantId", "customerId", "changedBy", "username", "requestId", "traceId", "imageId", "changes"]

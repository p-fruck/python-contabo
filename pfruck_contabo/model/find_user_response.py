...
class FindUserResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([UserResponse],),  # noqa: E501
            'links': (CreateUserResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindUserResponse - a model defined in OpenAPI

        Args:
            data ([UserResponse]):
            links (CreateUserResponseLinks):

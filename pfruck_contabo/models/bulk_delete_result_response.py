...
class BulkDeleteResultResponse(BaseModel):
    ...
    failed_ids: List[StrictInt] = Field(description="Failed zone record IDs", alias="failedIds")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "failedIds"]

...
class UnassignInstancePrivateNetworkResponse(BaseModel):
    """
    UnassignInstancePrivateNetworkResponse
    """ # noqa: E501
    links: InstanceAssignmentSelfLinks = Field(description="Links for easy navigation.", alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": InstanceAssignmentSelfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj

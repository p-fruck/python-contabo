...
class GenerateClientSecretResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[ClientSecretResponse]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """GenerateClientSecretResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this GenerateClientSecretResponse.  # noqa: E501


        :return: The data of this GenerateClientSecretResponse.  # noqa: E501
        :rtype: list[ClientSecretResponse]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this GenerateClientSecretResponse.


        :param data: The data of this GenerateClientSecretResponse.  # noqa: E501
        :type: list[ClientSecretResponse]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this GenerateClientSecretResponse.  # noqa: E501


        :return: The links of this GenerateClientSecretResponse.  # noqa: E501
        :rtype: AllOfGenerateClientSecretResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this GenerateClientSecretResponse.


        :param links: The links of this GenerateClientSecretResponse.  # noqa: E501
        :type: AllOfGenerateClientSecretResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GenerateClientSecretResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateClientSecretResponse):
            return False

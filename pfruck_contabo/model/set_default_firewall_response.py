...
class SetDefaultFirewallResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([FirewallResponse],),  # noqa: E501
            'links': (FindFirewallResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """SetDefaultFirewallResponse - a model defined in OpenAPI

        Args:
            data ([FirewallResponse]):
            links (FindFirewallResponseLinks):

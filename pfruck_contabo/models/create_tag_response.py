...
class CreateTagResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[CreateTagResponseData]',
    ...
    def data(self):
        ...
        :rtype: list[CreateTagResponseData]
        """
        return self._data
    ...
    def data(self, data):
        ...
        :type: list[CreateTagResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this CreateTagResponse.  # noqa: E501


        :return: The links of this CreateTagResponse.  # noqa: E501
        :rtype: AllOfCreateTagResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this CreateTagResponse.


        :param links: The links of this CreateTagResponse.  # noqa: E501
        :type: AllOfCreateTagResponseLinks
        """
        if links is None:

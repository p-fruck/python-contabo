...
class TestImageAuditResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ImageAuditResponseData:
        """Test ImageAuditResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAuditResponseData`
        """
        model = ImageAuditResponseData()
        if include_optional:
            return ImageAuditResponseData(
                id = 12345,
                action = 'CREATED',

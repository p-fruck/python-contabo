...
class RoleResponse(BaseModel):
    ...
    RoleResponse
    """ # noqa: E501
    role_id: StrictInt = Field(description="Role's id", alias="roleId")
    ...
    name: StrictStr = Field(description="Role's name")
    admin: StrictBool = Field(description="Admin")
    access_all_resources: StrictBool = Field(description="Access All Resources", alias="accessAllResources")
    type: StrictStr = Field(description="Role type can be either `default` or `custom`. The `default` roles cannot be modified or deleted.")
    permissions: Optional[List[PermissionResponse]] = None
    __properties: ClassVar[List[str]] = ["roleId", "tenantId", "customerId", "name", "admin", "accessAllResources", "type", "permissions"]

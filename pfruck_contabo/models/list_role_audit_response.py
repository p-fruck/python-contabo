...
class ListRoleAuditResponse(object):
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """ListRoleAuditResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this ListRoleAuditResponse.  # noqa: E501


        :return: The data of this ListRoleAuditResponse.  # noqa: E501
        :rtype: list[RoleAuditResponse]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ListRoleAuditResponse.


        :param data: The data of this ListRoleAuditResponse.  # noqa: E501
        :type: list[RoleAuditResponse]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this ListRoleAuditResponse.  # noqa: E501


        :return: The links of this ListRoleAuditResponse.  # noqa: E501
        :rtype: AllOfListRoleAuditResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this ListRoleAuditResponse.


        :param links: The links of this ListRoleAuditResponse.  # noqa: E501
        :type: AllOfListRoleAuditResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListRoleAuditResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRoleAuditResponse):
            return False

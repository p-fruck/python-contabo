...
class TestCreatePrivateNetworkResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreatePrivateNetworkResponse:
        """Test CreatePrivateNetworkResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePrivateNetworkResponse`
        """
        model = CreatePrivateNetworkResponse()
        if include_optional:

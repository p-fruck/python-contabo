...
class AddOnResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, quantity, *args, **kwargs):  # noqa: E501
        """AddOnResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, quantity, *args, **kwargs):  # noqa: E501
        """AddOnResponse - a model defined in OpenAPI

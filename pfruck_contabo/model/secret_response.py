...
class SecretResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant_id, customer_id, secret_id, name, type, value, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, customer_id, secret_id, name, type, value, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """SecretResponse - a model defined in OpenAPI

...
class PrivateNetworksAuditsApi:
    ...
    @validate_call
    def retrieve_private_network_audits_list(
        self,
        ...
        private_network_id: Annotated[Optional[StrictInt], Field(description="The identifier of the Private Network")] = None,
        request_id: Annotated[Optional[StrictStr], Field(description="The requestId of the API call which led to the change.")] = None,
        changed_by: Annotated[Optional[StrictStr], Field(description="User name which did the change.")] = None,
        ...
        :param private_network_id: The identifier of the Private Network
        :type private_network_id: int
        :param request_id: The requestId of the API call which led to the change.
        :type request_id: str
        :param changed_by: User name which did the change.
        :type changed_by: str
        ...
        _param = self._retrieve_private_network_audits_list_serialize(
    ...
    @validate_call
    def retrieve_private_network_audits_list_with_http_info(
        self,
        x_request_id: Annotated[str, Field(strict=True, description="[Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.")],
        x_trace_id: Annotated[Optional[StrictStr], Field(description="Identifier to trace group of requests.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of page to be fetched.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListPrivateNetworkAuditResponse]:
        """List history about your Private Networks (audit)
    ...
    @validate_call
    def retrieve_private_network_audits_list_without_preload_content(
        self,
        x_request_id: Annotated[str, Field(strict=True, description="[Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.")],
        x_trace_id: Annotated[Optional[StrictStr], Field(description="Identifier to trace group of requests.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of page to be fetched.")] = None,
    ...
    def _retrieve_private_network_audits_list_serialize(
        self,
        x_request_id,
        x_trace_id,
        page,
        ...
        if private_network_id is not None:
            ...
            _query_params.append(('privateNetworkId', private_network_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/private-networks/audits',

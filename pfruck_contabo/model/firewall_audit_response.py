...
class FirewallAuditResponse(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'firewall_id': 'firewallId',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, firewall_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """FirewallAuditResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, firewall_id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, *args, **kwargs):  # noqa: E501
        """FirewallAuditResponse - a model defined in OpenAPI

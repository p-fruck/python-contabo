...
class TestListPrivateNetworkResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListPrivateNetworkResponseData:
        """Test ListPrivateNetworkResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPrivateNetworkResponseData`
        """
        model = ListPrivateNetworkResponseData()
        if include_optional:
            return ListPrivateNetworkResponseData(
                tenant_id = 'DE',
                customer_id = '54321',

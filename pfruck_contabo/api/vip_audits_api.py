...
class VipAuditsApi:
    ...
    def retrieve_vip_audits_list(
        ...
        vip_id: Annotated[Optional[StrictStr], Field(description="The identifier of the VIP.")] = None,
        ...
        :param vip_id: The identifier of the VIP.
        :type vip_id: str
        ...
        _param = self._retrieve_vip_audits_list_serialize(
    ...
    @validate_call
    def retrieve_vip_audits_list_with_http_info(
        self,
        x_request_id: Annotated[str, Field(strict=True, description="[Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.")],
        x_trace_id: Annotated[Optional[StrictStr], Field(description="Identifier to trace group of requests.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of page to be fetched.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListVipAuditResponse]:
        """List history about your VIPs (audit)
    ...
    @validate_call
    def retrieve_vip_audits_list_without_preload_content(
        self,
        x_request_id: Annotated[str, Field(strict=True, description="[Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.")],
        x_trace_id: Annotated[Optional[StrictStr], Field(description="Identifier to trace group of requests.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Number of page to be fetched.")] = None,
    ...
    def _retrieve_vip_audits_list_serialize(
        self,
        x_request_id,
        x_trace_id,
        page,
        ...
        if vip_id is not None:
            ...
            _query_params.append(('vipId', vip_id))

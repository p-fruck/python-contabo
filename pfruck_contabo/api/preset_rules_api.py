...
class PresetRulesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_preset_rules_endpoint = _Endpoint(
            settings={
                'response_type': (ListPresetRulesResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/firewalls/preset-rules',
                'operation_id': 'retrieve_preset_rules',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_preset_rules(
        ...
        **kwargs
        ...
        >>> thread = api.retrieve_preset_rules(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['x_request_id'] = \
            x_request_id
        return self.retrieve_preset_rules_endpoint.call_with_http_info(**kwargs)

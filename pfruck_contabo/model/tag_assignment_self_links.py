...
class TagAssignmentSelfLinks(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _self, tag, resource, *args, **kwargs):  # noqa: E501
        """TagAssignmentSelfLinks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, _self, tag, resource, *args, **kwargs):  # noqa: E501
        """TagAssignmentSelfLinks - a model defined in OpenAPI

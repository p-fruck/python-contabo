...
class SsoTokenResponse(BaseModel):
    ...
    sso_token: StrictStr = Field(description="SSO token UUID used for single sign-on.", alias="ssoToken")
    url: StrictStr = Field(description="SSO URL to redirect the user to my.contabo.com.")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "ssoToken", "url"]

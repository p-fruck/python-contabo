...
class DpaAuditsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_dpa_audits_list_endpoint = _Endpoint(
            settings={
                'response_type': (ListDpaAuditResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/dpas/audits',
                'operation_id': 'retrieve_dpa_audits_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_dpa_audits_list(
        ...
        **kwargs
        ...
        List and filters the history about your Dpas.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.retrieve_dpa_audits_list(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['x_request_id'] = \
            x_request_id
        return self.retrieve_dpa_audits_list_endpoint.call_with_http_info(**kwargs)

...
class PatchInstanceResponseData(BaseModel):
    """
    ...
    created_date: datetime = Field(description="Creation date of the instance", alias="createdDate")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "instanceId", "createdDate"]

...
class ReinstallInstanceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ReinstallInstanceResponseData],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """ReinstallInstanceResponse - a model defined in OpenAPI

        Args:
            data ([ReinstallInstanceResponseData]):

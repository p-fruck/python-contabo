...
class AutoScalingTypeResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state, size_limit_tb, *args, **kwargs):  # noqa: E501
        """AutoScalingTypeResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, state, size_limit_tb, *args, **kwargs):  # noqa: E501
        """AutoScalingTypeResponse - a model defined in OpenAPI

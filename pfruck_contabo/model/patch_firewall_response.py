...
class PatchFirewallResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'links': (CreateFirewallResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """PatchFirewallResponse - a model defined in OpenAPI

        Args:
            data ([FirewallResponse]):
            links (CreateFirewallResponseLinks):

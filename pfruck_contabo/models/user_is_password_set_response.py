...
class UserIsPasswordSetResponse(BaseModel):
    """
    ...
    is_password_set: StrictBool = Field(description="Indicates if the user has set a password for his account", alias="isPasswordSet")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "isPasswordSet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isPasswordSet": obj.get("isPasswordSet")
        })
        return _obj

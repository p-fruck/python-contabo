...
class TestListImageResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListImageResponse:
        """Test ListImageResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListImageResponse`
        """
        ...
        if include_optional:
            return ListImageResponse(
                pagination = pfruck_contabo.models.pagination_meta.PaginationMeta(
                    ...
                    page = 1, ),
                data = [
                    pfruck_contabo.models.list_image_response_data.ListImageResponseData(

...
class CreateTagRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            color (str): The color of the tag. Color can be specified using hexadecimal value. Default color is #0A78C3. defaults to "#0A78C3"  # noqa: E501

...
class UpdateCustomImageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([UpdateCustomImageResponseData],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """UpdateCustomImageResponse - a model defined in OpenAPI

        Args:
            data ([UpdateCustomImageResponseData]):

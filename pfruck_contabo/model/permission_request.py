...
class PermissionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_name, actions, *args, **kwargs):  # noqa: E501
        """PermissionRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            resources ([int]): The IDs of tags. Only if those tags are assgined to a resource the user with that role will be able to access the resource.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_name, actions, *args, **kwargs):  # noqa: E501
        """PermissionRequest - a model defined in OpenAPI

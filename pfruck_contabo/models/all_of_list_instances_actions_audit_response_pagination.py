...
import six
from pfruck_contabo.models.pagination_meta import PaginationMeta  # noqa: F401,E501

class AllOfListInstancesActionsAuditResponsePagination(PaginationMeta):
    ...
    if hasattr(PaginationMeta, "swagger_types"):
        swagger_types.update(PaginationMeta.swagger_types)

    attribute_map = {
    }
    if hasattr(PaginationMeta, "attribute_map"):
        attribute_map.update(PaginationMeta.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfListInstancesActionsAuditResponsePagination - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        PaginationMeta.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfListInstancesActionsAuditResponsePagination, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfListInstancesActionsAuditResponsePagination):
            return False

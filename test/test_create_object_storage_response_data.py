...
class TestCreateObjectStorageResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateObjectStorageResponseData:
        """Test CreateObjectStorageResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateObjectStorageResponseData`
        """
        model = CreateObjectStorageResponseData()
        if include_optional:
            return CreateObjectStorageResponseData(
                tenant_id = 'DE',
                customer_id = '54321',

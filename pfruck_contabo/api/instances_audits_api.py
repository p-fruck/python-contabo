...
class InstancesAuditsApi(object):
    ...
    def retrieve_instances_audits_list(self, x_request_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.retrieve_instances_audits_list_with_http_info(x_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_instances_audits_list_with_http_info(x_request_id, **kwargs)  # noqa: E501
            return data

    def retrieve_instances_audits_list_with_http_info(self, x_request_id, **kwargs):  # noqa: E501
        """List history about your instances (audit) triggered via the API  # noqa: E501

        List and filters the history about your instances your triggered via the API.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_instances_audits_list_with_http_info(x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method retrieve_instances_audits_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('x_request_id' not in params or
            ...
            raise ValueError("Missing the required parameter `x_request_id` when calling `retrieve_instances_audits_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/compute/instances/audits', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ListInstancesAuditResponse',  # noqa: E501

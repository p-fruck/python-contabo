...
class CreateRoleResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[CreateRoleResponseData]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """CreateRoleResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this CreateRoleResponse.  # noqa: E501


        :return: The data of this CreateRoleResponse.  # noqa: E501
        :rtype: list[CreateRoleResponseData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CreateRoleResponse.


        :param data: The data of this CreateRoleResponse.  # noqa: E501
        :type: list[CreateRoleResponseData]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this CreateRoleResponse.  # noqa: E501


        :return: The links of this CreateRoleResponse.  # noqa: E501
        :rtype: AllOfCreateRoleResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this CreateRoleResponse.


        :param links: The links of this CreateRoleResponse.  # noqa: E501
        :type: AllOfCreateRoleResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRoleResponse, dict):

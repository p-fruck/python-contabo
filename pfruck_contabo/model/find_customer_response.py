...
class FindCustomerResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CustomerResponse],),  # noqa: E501
            'links': (FindCustomerResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindCustomerResponse - a model defined in OpenAPI

        Args:
            data ([CustomerResponse]):
            links (FindCustomerResponseLinks):

...
class PaginationMeta(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'total_elements': (float,),  # noqa: E501
            'total_pages': (float,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, size, total_elements, total_pages, page, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, size, total_elements, total_pages, page, *args, **kwargs):  # noqa: E501
        """PaginationMeta - a model defined in OpenAPI

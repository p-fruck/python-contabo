...
import six
from pfruck_contabo.models.links import Links  # noqa: F401,E501

class AllOfListInstancesActionsAuditResponseLinks(Links):
    ...
    if hasattr(Links, "swagger_types"):
        swagger_types.update(Links.swagger_types)

    attribute_map = {
    }
    if hasattr(Links, "attribute_map"):
        attribute_map.update(Links.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfListInstancesActionsAuditResponseLinks - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        Links.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfListInstancesActionsAuditResponseLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfListInstancesActionsAuditResponseLinks):
            return False

...
**gpu_vendor** | **str** | Vendor of the GPU assigned to the instance, if any. Null when no GPU is attached. | [optional] 
**gpu_model** | **str** | Model of the GPU assigned to the instance, if any. Null when no GPU is attached. | [optional] 

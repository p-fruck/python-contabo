...
class FindUserIsPasswordSetResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[UserIsPasswordSetResponse]',
    ...
    def __init__(self, data=None, links=None):  # noqa: E501
        """FindUserIsPasswordSetResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._links = None
    ...
    @property
    def data(self):
        """Gets the data of this FindUserIsPasswordSetResponse.  # noqa: E501


        :return: The data of this FindUserIsPasswordSetResponse.  # noqa: E501
        :rtype: list[UserIsPasswordSetResponse]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this FindUserIsPasswordSetResponse.


        :param data: The data of this FindUserIsPasswordSetResponse.  # noqa: E501
        :type: list[UserIsPasswordSetResponse]
        """
        if data is None:
    ...
    @property
    def links(self):
        """Gets the links of this FindUserIsPasswordSetResponse.  # noqa: E501


        :return: The links of this FindUserIsPasswordSetResponse.  # noqa: E501
        :rtype: AllOfFindUserIsPasswordSetResponseLinks
        """
        return self._links

    @links.setter
    def links(self, links):
        """Sets the links of this FindUserIsPasswordSetResponse.


        :param links: The links of this FindUserIsPasswordSetResponse.  # noqa: E501
        :type: AllOfFindUserIsPasswordSetResponseLinks
        """
        if links is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FindUserIsPasswordSetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FindUserIsPasswordSetResponse):
            return False

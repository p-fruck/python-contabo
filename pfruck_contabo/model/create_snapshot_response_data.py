...
class CreateSnapshotResponseData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant_id, customer_id, snapshot_id, image_id, image_name, *args, **kwargs):  # noqa: E501
        """CreateSnapshotResponseData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, customer_id, snapshot_id, image_id, image_name, *args, **kwargs):  # noqa: E501
        """CreateSnapshotResponseData - a model defined in OpenAPI

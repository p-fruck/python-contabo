...
class DomainAuthCodeRegenerateResponse(BaseModel):
    """
    DomainAuthCodeRegenerateResponse
    """ # noqa: E501
    data: List[DomainAuthCodeResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DomainAuthCodeResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

# pfruck_contabo.FirewallsAuditsApi
...
> ListFirewallAuditResponse retrieve_firewall_audits_list(x_request_id, x_trace_id=x_trace_id, page=page, size=size, order_by=order_by, firewall_id=firewall_id, request_id=request_id, changed_by=changed_by, start_date=start_date, end_date=end_date)
...
with pfruck_contabo.ApiClient(configuration) as api_client:
    ...
    api_instance = pfruck_contabo.FirewallsAuditsApi(api_client)
    ...
    try:
        ...
        print("The response of FirewallsAuditsApi->retrieve_firewall_audits_list:\n")
        pprint(api_response)

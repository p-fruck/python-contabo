...
class UserAuditResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, user_id, *args, **kwargs):  # noqa: E501
        """UserAuditResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, action, timestamp, tenant_id, customer_id, changed_by, username, request_id, trace_id, user_id, *args, **kwargs):  # noqa: E501
        """UserAuditResponse - a model defined in OpenAPI

...
class FindCredentialResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CredentialData],),  # noqa: E501
            'links': (FindCredentialResponseLinks,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """FindCredentialResponse - a model defined in OpenAPI

        Args:
            data ([CredentialData]):
            links (FindCredentialResponseLinks):

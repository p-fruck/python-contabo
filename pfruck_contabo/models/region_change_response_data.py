...
class RegionChangeResponseData(BaseModel):
    """
    ...
    ticket_number: StrictInt = Field(description="Support ticket number created for the region change", alias="ticketNumber")
    __properties: ClassVar[List[str]] = ["tenantId", "customerId", "ticketNumber"]

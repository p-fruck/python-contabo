...
class InstanceStatusRepresentation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instance_id, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, instance_id, status, *args, **kwargs):  # noqa: E501
        """InstanceStatusRepresentation - a model defined in OpenAPI

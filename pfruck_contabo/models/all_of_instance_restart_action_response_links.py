...
import six
from pfruck_contabo.models.self_links import SelfLinks  # noqa: F401,E501

class AllOfInstanceRestartActionResponseLinks(SelfLinks):
    ...
    if hasattr(SelfLinks, "swagger_types"):
        swagger_types.update(SelfLinks.swagger_types)

    attribute_map = {
    }
    if hasattr(SelfLinks, "attribute_map"):
        attribute_map.update(SelfLinks.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfInstanceRestartActionResponseLinks - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        SelfLinks.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfInstanceRestartActionResponseLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfInstanceRestartActionResponseLinks):
            return False

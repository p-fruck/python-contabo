...
class PatchInstanceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([PatchInstanceResponseData],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, links, *args, **kwargs):  # noqa: E501
        """PatchInstanceResponse - a model defined in OpenAPI

        Args:
            data ([PatchInstanceResponseData]):

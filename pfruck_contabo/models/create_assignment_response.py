...
class CreateAssignmentResponse(BaseModel):
    ...
    """ # noqa: E501
    links: TagAssignmentSelfLinks = Field(description="Links for easy navigation.", alias="_links")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": TagAssignmentSelfLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None
        })
        return _obj

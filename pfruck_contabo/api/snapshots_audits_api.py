...
class SnapshotsAuditsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_snapshots_audits_list_endpoint = _Endpoint(
            settings={
                'response_type': (ListSnapshotsAuditResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/v1/compute/snapshots/audits',
                'operation_id': 'retrieve_snapshots_audits_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_snapshots_audits_list(
        ...
        **kwargs
        ...
        kwargs['x_request_id'] = \
            x_request_id
        return self.retrieve_snapshots_audits_list_endpoint.call_with_http_info(**kwargs)
